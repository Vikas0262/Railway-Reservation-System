        ...
        <form method="post" action="index.jsp">
          <div class="user-details">
            ...
            <div class="input-box">
              ...
              <input type="text" placeholder="Enter Your Name" value="<%=session.getAttribute("Name")%>" required name="name" disabled />
            </div>
            <div class="input-box">
              <span class="details"> Password</span>
              <input type="text" placeholder="Source" value="<%=session.getAttribute("Password")%>" required name="password" disabled/>
            </div>
          </div>
          <button class="button" type="submit">Back To Home Page</button>
           <button class="button1" type="submit">Reset</button>
